...
public class MyFrame extends JFrame implements ActionListener {
	...
	public MyFrame(String title) {
		...
		deleteBtn.addActionListener(this); // this는 myFrame
	...
	public void actionPerformed(ActionEvent e) {
		 ...
		 * 문자열이 참조값이 아닌 내용이 같은지 비교할 때는 String의 .equals() 메소드를 이용해야 한다.
		 * 
		 * 왜냐하면 java에서는 문자열을 만드는 방법에 따라서 내용은 같지만 참조값이 다르게 나오는 경우도
		 * 있기 때문. 따라서 문자열의 내용이 같은지 정.확.히 비교할 때는 반드시 .equals() 메소드 이용해야 함
		 */
