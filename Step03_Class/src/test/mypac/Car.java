 ...
 * 
 * 1. 객체의 설계도 역할
 *   - 객체는 heap 영역(사물함)에 들어 있는 물건이라고 생각하면 된다.(참조값 x)
...
public class Car {
	/*
	 * [필드 정의하기] - 클래스의 {} 중괄호 안에 아래와 같은 형식으로 필드를 정의할 수 있다. - 초기 값을 부여하지 않으면 기본 값이
	 * 들어간다. - int의 기본 값은 0, boolean의 기본 값은 false, 참조데이터 type의 기본은 null
	 * 
